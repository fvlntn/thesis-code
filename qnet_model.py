...
class Abstract3DUNet(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid, basic_module, f_maps=64, layer_order='gcr',
        ...
        self.fc1 = nn.Conv3d(512, 20, 1)
        self.fc2 = nn.Linear(20*16*16*16, 3)
    ...
    def forward(self, x):
        ...
        # During training the network outputs logits and it's up to the user to normalize it
